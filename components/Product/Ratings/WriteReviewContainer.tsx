    ...
    if (userHasReviewed === null) {
      try {
        const response = await axios.post(
          `https://ecommercebackend-production-40c6.up.railway.app/api/v1/games/${game?._id}/reviews`,
          {
            headline: headline,
            rating: rating,
            review: review,
      ...
      try {
        const response = await axios.patch(
          `https://ecommercebackend-production-40c6.up.railway.app/api/v1/reviews/${userHasReviewed?._id}`,
          {
            headline: headline,
            rating: rating,
            review: review,
