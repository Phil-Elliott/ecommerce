...
const Hero = () => {
  return (
    <div className="relative container mx-auto pt-20 flex justify-center items-center">
      {/* <Image
        src={HeroImg}
        alt="Hero"
      ...
      <div className="absolute flex flex-col justify-center items-center gap-8 ">
        <h1 className="text-white font-bold text-8xl w-2/3 text-center text-shadow">
        ...
        <Link href="/shop">
          <Button
            ariaLabel="Shop All"
            className="bg-Tertiary text-Primary font-semibold py-2 px-8 text-2xl rounded-sm shadow hover:bg-Secondary transition duration-200 ease-in-out"
          >
            Shop All
          </Button>
        </Link>
